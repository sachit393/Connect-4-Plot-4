...
var player2Color = 'rgb(255, 85, 51)';
...
$('.board button').on('click',function() {
  ...
  if (currentPlayer === 1) {
    currentName = player1;
    $('h3').text(currentName+": , please pick a column to drop your blue chip.");
    currentColor = player1Color;
  }else {
    currentName = player2
    $('h3').text(currentName+":, please pick a column to drop your orange chip.");
